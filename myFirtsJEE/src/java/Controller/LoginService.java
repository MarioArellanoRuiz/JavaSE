...
public class LoginService extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try(PrintWriter out = response.getWriter()) {
            ...
            out.println("</body>");
            out.println("</html>");
             LoginBean myLogin = new LoginBean();
             myLogin.setCorreo(request.getParameter("usuario"));
             myLogin.setPassword("s3cret");
             if(myLogin.verificarPaswword(request.getParameter("password"))){
